...
public class Dashboard extends javax.swing.JFrame {
    ...
    public Dashboard(String id){
        ...
        changeContent(new student_form.Home());
    ...
    private void initComponents() {
        ...
        nav.setBackground(new java.awt.Color(255, 57, 57));
        ...
        home.setBackground(new java.awt.Color(251, 99, 89));
        ...
        transaction.setBackground(new java.awt.Color(251, 99, 89));
        transaction.setFont(new java.awt.Font("Arial", 1, 16)); // NOI18N
        ...
        history.setBackground(new java.awt.Color(251, 99, 89));
        ...
        account.setBackground(new java.awt.Color(251, 99, 89));
        ...
        logout.setBackground(new java.awt.Color(251, 99, 89));
    ...
    private void navigationBTN(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_navigationBTN
        ...
        if (clickedBTN.equals("Home") && !currentNav.equals("Home")) {
        ...
        }else if (clickedBTN.equals("Transactions") && !currentNav.equals("Transactions")) {
            changeContent(new student_form.Transaction());
            transaction.setBorder(BorderFactory.createLineBorder(new Color(255, 255, 255), 2));
            currentNav = "Transactions";

        
        }else if (clickedBTN.equals("History") && !currentNav.equals("History")) {
            changeContent(new student_form.History());
            ...
            changeContent(new student_form.Account());
