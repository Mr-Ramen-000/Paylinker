...
public class Account extends javax.swing.JPanel {
    ...
    public Account() {
        ...
        firstname.setText(studentInfo[0]);
        lastname.setText(studentInfo[1]);
        email.setText(studentInfo[2]);
    ...
    private void initComponents() {
        ...
        updateBasicInfo.setBackground(new java.awt.Color(255, 57, 57));
        ...
        updateSecurity.setBackground(new java.awt.Color(255, 57, 57));
    ...
    private void dataChange(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_dataChange
        if (evt.getComponent() == firstname || evt.getComponent() == lastname) {       
            if (!firstname.getText().equals(studentInfo[0]) || !lastname.getText().equals(studentInfo[1])) {
            ...
            if (!email.getText().equals(studentInfo[2]) || oldPassword.getPassword().length != 0 || newPassword.getPassword().length != 0) {
    ...
    private void updateBasicInfoMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_updateBasicInfoMouseReleased
        if (updateBasicInfo.isEnabled()) {
            if (firstname.getText().isEmpty() || lastname.getText().isEmpty()){
                ...
                boolean update = database.StudentConnection.updateBasicInfo(firstname.getText(), lastname.getText(), Dashboard.getAccountId());
                if (update) {
                    updateBasicInfo.setEnabled(false);
                    studentInfo = database.StudentConnection.studentInfo(Dashboard.getAccountId());
    ...
    private void updateSecurityMouseReleased(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_updateSecurityMouseReleased
        if (updateSecurity.isEnabled()) {
            if (email.getText().isEmpty()){
                ...
                } else if (!(String.valueOf(oldPassword.getPassword()).equals(studentInfo[3]))){
                    JOptionPane.showMessageDialog(null, "Make sure your old password is match.",
                           null, JOptionPane.INFORMATION_MESSAGE);

                } else {
                    studentSecurityUpdate();
                }
    ...
    private void studentSecurityUpdate(){
        boolean update = database.StudentConnection.updateSecurityInfo(email.getText(), String.valueOf(newPassword.getPassword()), Dashboard.getAccountId());
            if (update) {
